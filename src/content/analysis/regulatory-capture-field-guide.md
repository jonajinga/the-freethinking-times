...
Regulatory capture — the process by which regulatory agencies come to serve the interests of the industries they were created to oversee — is one of those concepts that gets invoked frequently and understood rarely. The textbook version describes a simple arc: industry lobbies, regulator bends, public loses. This is accurate as far as it goes, but it misses the texture of how it actually happens, which is considerably more interesting and considerably more difficult to remedy.{% fn 1 %}The term was formalised by economist George Stigler in his 1971 paper "The Theory of Economic Regulation," published in the Bell Journal of Economics. Stigler argued that regulation is typically designed and operated for the benefit of the industries being regulated. He received the Nobel Prize in Economics in 1982 partly for this work.{% endfn %}
...
The revolving door between regulatory agencies and the industries they oversee is well documented.{% fn 2 %}A 2013 study by the Government Accountability Office found that roughly half of senior officials leaving federal financial regulators moved into private-sector roles in the industries they had overseen. The salary differential can be an order of magnitude.{% endfn %} What is less often discussed is how it shapes behavior before anyone has left for a private-sector job.
...
Over time, agencies that recruit heavily from industry and lose experienced staff to industry develop something that might be called an epistemic monoculture:{% fn 3 %}The philosopher Helen Longino developed a detailed account of how scientific communities can become epistemically closed in *Science as Social Knowledge* (1990). The application to regulatory environments is our own, but the underlying mechanism — shared background assumptions that become invisible precisely because they are shared — is hers.{% endfn %} a shared set of assumptions about what is normal, what is reasonable, and what is excessive that closely mirrors the industry's own self-conception.

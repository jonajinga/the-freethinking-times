...
corrections:
  - date: "2026-03-12"
    description: "An earlier version of this article referred to 'epistemic cowardice' as a phrase coined by Bernard Williams. The phrase appears in philosophical literature in various forms but is not attributable to Williams specifically. The attribution has been removed."
---
...
A commentator who responds to every strong claim with "well, there are many perspectives" is not enriching public discourse. They are flattening it — treating the person with evidence and the person with a financial interest in disputing that evidence as epistemically equivalent parties in a good-faith disagreement.{% fn 2 %}The philosopher Elizabeth Anderson has described this pattern as "epistemic democracy gone wrong" — a misapplication of democratic norms of equal voice to contexts where equal weight is not epistemically warranted. The IPCC does not hold a vote between its climate scientists and the oil industry's communications teams.{% endfn %}
